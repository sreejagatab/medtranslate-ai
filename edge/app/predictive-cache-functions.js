 ...
 */
function getLocationBasedPredictions(locationName, threshold, options = {}) {
  try {
    const predictions = [];
 ...
 */
function getDeviceBasedPredictions(batteryLevel, networkSpeed, threshold, options = {}) {
  try {
    const predictions = [];
    const { offlineRisk, offlineRiskOnly } = options;
 ...
 */
function getComplexityBasedPredictions(currentContext, threshold, options = {}) {
  try {
    const predictions = [];
    const { offlineRisk, offlineRiskOnly } = options;
